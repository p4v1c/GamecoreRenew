...
def area(f):
    ...
    return 'default-ui'
EMOJI=re.compile('[\U0001F300-\U0001FAFF\U00002600-\U000026FF\U00002700-\U000027BF\U0001F000-\U0001F2FF]')
PAD=set('✕○△□')
checks={
 ...
 'arrow in text':re.compile(r'[\'">`][^\'"<`]*\s(→|->)\s*[\'"<`]'),
 'middle-dot meta':re.compile(r'\S · \S'),
