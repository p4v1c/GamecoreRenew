...
export const consoles = {
  ...
  snes9x: ['snes.png', 'Super Nintendo', 'Nintendo', '1990 / 1992', '#b6a4ff', 'SNES',
    'Sixteen bits of pure color. The golden age of Mode 7 and legendary soundtracks.'],
  nes: ['nes.png', 'NES', 'Nintendo', '1983 / 1986', '#ff9a9a', 'NES',
    'Where it all started again. Eight-bit classics that taught a generation to play.'],
  fds: ['fds.png', 'Famicom Disk System', 'Nintendo', '1986', '#ffab8a', 'FDS',
    'Games on a disk, a Japanese exclusive. The Famicom with a little extra room.'],
  mastersystem: ['mastersystem.png', 'Master System', 'Sega', '1985 / 1987', '#8fb8ff', 'SMS',
    "Sega's first great home console. Bright colors and arcade spirit in eight bits."],
  gamegear: ['gamegear.png', 'Game Gear', 'Sega', '1990', '#a9bccd', 'GG',
    'A full-color screen in your hands. Sega arcade classics on the go.'],
  sg1000: ['sg1000.png', 'SG-1000', 'Sega', '1983', '#8fd0ff', 'SG',
    "Where Sega's home story begins. Simple, direct games from the very first cartridge."],
  megadrive: ['megadrive.png', 'Mega Drive', 'Sega', '1988 / 1990', '#aab4ff', 'MD',
    'Blast processing and attitude. Sixteen-bit speed that changed the console wars.'],
  megacd: ['megacd.png', 'Mega-CD', 'Sega', '1991 / 1993', '#9ec3d6', 'MCD',
    'CD audio and full-motion video. The Mega Drive, with a disc drive underneath.'],
  sega32x: ['32x.png', '32X', 'Sega', '1994', '#ffb07a', '32X',
    'A mushroom on top of the Mega Drive. Thirty-two bits for a short, bold moment.'],
  saturn: ['saturn.png', 'Saturn', 'Sega', '1994 / 1995', '#b9c2ce', 'SAT',
    'Two processors, pure arcade blood. Fighting games and shooters at their finest.'],
  dreamcast: ['dreamcast.png', 'Dreamcast', 'Sega', '1998 / 1999', '#ffb562', 'DC',
    'Ahead of its time, online from day one. The last Sega console, and a favorite.'],
  naomi: ['naomi.png', 'Naomi', 'Sega', '1998', '#6fd6d6', 'NAOMI',
    'The arcade board behind the Dreamcast. Cabinet classics, straight from the arcade.'],
  naomigd: ['naomi.png', 'Naomi GD-ROM', 'Sega', '2001', '#6fd0b8', 'GD',
    'Naomi games on GD-ROM discs. More arcade titles, loaded from disc.'],
  atomiswave: ['atomiswave.png', 'Atomiswave', 'Sammy', '2003', '#ff9a6a', 'AW',
    'A cartridge arcade system with fighting-game spirit. Swap the cartridge, change the game.'],
  pcengine: ['pcengine.png', 'PC Engine', 'NEC', '1987 / 1989', '#e8e8f0', 'PCE',
    'A tiny console with huge shooters. HuCards and arcade-perfect action.'],
  pcenginecd: ['pcenginecd.png', 'PC Engine CD', 'NEC', '1988 / 1989', '#ff9191', 'PCE CD',
    'The first CD-ROM console. Red Book audio and animated cut-scenes in the eighties.'],
  supergrafx: ['supergrafx.png', 'SuperGrafx', 'NEC', '1989', '#d6b494', 'SGX',
    'The PC Engine, doubled. A rare powerhouse with a handful of exclusives.'],
  mame: ['arcade.png', 'Arcade', 'MAME', '', '#ffd36a', 'ARC',
    'Insert coin. Decades of arcade games, preserved and ready to play.'],
}
